...
const Connected = () => {
  return (
    <section id='contact' className='pt-[8%] max-sm:pt-[20%] px-20 max-sm:px-5'>
      ...
      <div className="flex gap-10 md:mt-12 my-7 flex-col lg:flex-row lg:items-stretch">
        <div className="basis-1/2" data-aos="fade-right">
          ...
          <p className='text-slate-700 mt-5 text-justify'>Blockchain Lautech has been championing blockchain education since 2020. Through workshops, hackathons, and community building, we&apos;ve created a vibrant ecosystem that connects LAUTECH students to the global Web3 movement.
          </p>
        ...
        <div className="basis-1/2 h-full" data-aos="fade-left">
          <div className='bg-white shadow rounded-lg p-6 border-l-3 border-conblue font-medium text-slate-700'>
            <h3> Our Mission: To democratize blockchain education and foster innovation from Nigeria to the world.</h3>
          </div>
          ...
          {/* <div className="flex flex-col gap-5 h-full"> */}
            {/* <div className='p-3 bg-white rounded-lg shadow flex gap-5 w-full h-full flex flex-col justify-center items-center text-center py-10' data-aos="fade-bottom">
              ...
              <div>
                <h3 className='text-lg'>General Inquiries, Sponsorship & Partnership</h3>
                <a href="mailto:blockchainlautech@gmail.com">
